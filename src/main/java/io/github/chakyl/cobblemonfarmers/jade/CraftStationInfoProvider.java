...
public enum CraftStationInfoProvider implements IBlockComponentProvider, IServerDataProvider<BlockAccessor> {
    INSTANCE;
    ...
    public void appendServerData(CompoundTag data, BlockAccessor accessor) {
        CraftStationBlockEntity stationBaseBlockEntity = (CraftStationBlockEntity) accessor.getBlockEntity();
