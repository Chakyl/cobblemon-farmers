...
public class JEIRanchingStationMilkingCategory implements IRecipeCategory<RanchingStationMilkingRecipe> {
    ...
    public JEIRanchingStationMilkingCategory(IGuiHelper guiHelper) {
