...
public class CraftStationMenu extends AbstractWorkerMenu {
    ...
    public CraftStationMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(CobblemonFarmersRegistery.MenuRegistry.CRAFT_STATION.get(), pContainerId, inv, entity, data);
        checkContainerSize(inv, 2);
        blockEntity = ((CraftStationBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, CobblemonFarmersRegistery.BlockRegistry.CRAFT_STATION.get());
    }
    ...
    private class PartySlot extends WorkstationPartySlot {
        ...
        public Optional<ItemStack> tryRemove(int pCount, int pDecrement, Player pPlayer) {
            CraftStationMenu.this.transferFromPartyToWorkerSlot(player, this);
