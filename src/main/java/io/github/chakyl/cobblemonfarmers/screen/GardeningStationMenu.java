...
public class GardeningStationMenu extends AbstractWorkerMenu {
    ...
    public GardeningStationMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(CobblemonFarmersRegistery.MenuRegistry.GARDENING_STATION.get(), pContainerId, inv, entity, data);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, CobblemonFarmersRegistery.BlockRegistry.GARDENING_STATION.get());
    }
