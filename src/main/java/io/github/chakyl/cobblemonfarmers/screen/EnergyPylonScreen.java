...
public class EnergyPylonScreen extends AbstractContainerScreen<EnergyPylonMenu> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(CobblemonFarmers.MODID, "textures/gui/energy_pylon.png");
    ...
    private static final Component CONTAINER_LABEL = Component.translatable("gui.cobblemon_farmers.energy_pylon");
    ...
    public EnergyPylonScreen(EnergyPylonMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
