...
public class MysteryMineMenu extends AbstractWorkerMenu {
    ...
    public MysteryMineMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(CobblemonFarmersRegistery.MenuRegistry.MYSTERY_MINE.get(), pContainerId, inv, entity, data);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, CobblemonFarmersRegistery.BlockRegistry.MYSTERY_MINE.get());
    }
