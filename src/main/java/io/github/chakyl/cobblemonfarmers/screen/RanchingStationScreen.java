...
public class RanchingStationScreen extends AbstractContainerScreen<RanchingStationMenu> {
    ...
    protected void renderLabels(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY) {
        ...
        if (pokemon != null) {
            ...
            GuiUtilsKt.drawText(pGuiGraphics, COBBLE_FONT, Component.translatable("info.cobblemon_farmers.ranching_station.type." + pokemon.getPrimaryType().getName().toLowerCase()), centralX + 90, 44, false, 0xFFFFFFFF, false, 0, 0);
            if (pokemon.getSecondaryType() != null) {
                GuiUtilsKt.drawText(pGuiGraphics, COBBLE_FONT, Component.translatable("info.cobblemon_farmers.ranching_station.type." + pokemon.getSecondaryType().getName().toLowerCase()), centralX + 90, 58, false, 0xFFFFFFFF, false, 0, 0);
            }
        }
    }
