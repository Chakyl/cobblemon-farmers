...
public class GardeningStationScreen extends AbstractContainerScreen<GardeningStationMenu> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(CobblemonFarmers.MODID, "textures/gui/gardening_station.png");
    ...
    private static final Component CONTAINER_LABEL = Component.translatable("gui.cobblemon_farmers.gardening_station");
    ...
    protected void renderLabels(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY) {
        ...
        if (speedMod > 0) {
            GuiUtilsKt.drawText(pGuiGraphics, COBBLE_FONT, Component.translatable("gui.cobblemon_farmers.speed", speedMod), centralX , 47, false,0xFFFFFFFF, true, 0, 0);
        }
        int workingRadius = this.menu.getAoeRadius();
        if (workingRadius > 0) {
            GuiUtilsKt.drawText(pGuiGraphics, COBBLE_FONT, Component.translatable("gui.cobblemon_farmers.working_radius", workingRadius), centralX , 58, false,0xFFFFFFFF, true, 0, 0);
        }
        ...
        if (pokemon != null) {
            ...
            GuiUtilsKt.drawText(pGuiGraphics, COBBLE_FONT, Component.translatable("info.cobblemon_farmers.gardening_station.type." + pokemon.getPrimaryType().getName().toLowerCase()), centralX + 90, 34, false, 0xFFFFFFFF, false, 0, 0);
            if (pokemon.getSecondaryType() != null) {
                GuiUtilsKt.drawText(pGuiGraphics, COBBLE_FONT, Component.translatable("info.cobblemon_farmers.gardening_station.type." + pokemon.getSecondaryType().getName().toLowerCase()), centralX + 90, 48, false, 0xFFFFFFFF, false, 0, 0);
            }
        }
