...
public class MysteryMineRecipe implements Recipe<RecipeWrapper> {
    ...
    public RecipeSerializer<?> getSerializer() {
        return CobblemonFarmersRegistery.RecipeRegistry.MYSTERY_MINE_SERIALIZER.get();
    }
    ...
    public static class Serializer implements RecipeSerializer<MysteryMineRecipe> {
        ...
        public static final ResourceLocation ID = new ResourceLocation(CobblemonFarmers.MODID, "mystery_mine");
