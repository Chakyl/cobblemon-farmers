...
public class MysteryMineScreen extends AbstractContainerScreen<MysteryMineMenu> {
    ...
    protected void renderLabels(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY) {
        ...
        if (multChance > 0) {
            GuiUtilsKt.drawCenteredText(pGuiGraphics, COBBLE_FONT, Component.translatable("gui.cobble_workers.mult_chance", multChance + "%"), centralX + 44, 56, 0xFFFFFFFF, true);
        }
    ...
    private Component getCraftingTimeTooltip() {
        ...
        if (remainingTicks > 0 && this.menu.getScaledProgress() > 0) {
            ...
            return Component.translatable("tooltip.cobble_workers.mystery_mine.processing_time", formattedTime);
        } else {
            return Component.translatable("tooltip.cobble_workers.mystery_mine.processing_time", "0:00 Seconds");
        }
    }
