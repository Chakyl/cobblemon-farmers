...
public class CraftStationCategory implements IRecipeCategory<CraftStationRecipe> {
    public static final RecipeType<CraftStationRecipe> TYPE = RecipeType.create(CobbleWorkers.MODID, "craft_station", CraftStationRecipe.class);
    public static final ResourceLocation TEXTURE = new ResourceLocation(CobbleWorkers.MODID, "textures/jei/craft_station.png");
    ...
    public CraftStationCategory(IGuiHelper guiHelper) {
        ...
        this.icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(CobbleWorkersRegistery.BlockRegistry.CRAFT_STATION.get()));
        this.name = Component.translatable(CobbleWorkersRegistery.BlockRegistry.CRAFT_STATION.get().getDescriptionId());
    }
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, CraftStationRecipe recipe, IFocusGroup focuses) {
        builder.addSlot(RecipeIngredientRole.INPUT, 89, 13).addItemStack(recipe.getInputItem(null));
        builder.addSlot(RecipeIngredientRole.OUTPUT, 142, 13).addItemStack(recipe.getResultItem(null));
    }
    ...
    public void draw(CraftStationRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
        ...
        guiGraphics.drawString(Minecraft.getInstance().font, Language.getInstance().getVisualOrder(Component.translatable("jei.cobble_workers.craft_station.crafting_time", recipe.getCraftingTime() / 20)), 86, 38, 0xFFFFFFFF, false);
    }
