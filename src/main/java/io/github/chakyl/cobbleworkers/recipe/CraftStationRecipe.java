...
public class CraftStationRecipe implements Recipe<RecipeWrapper> {
    ...
    public RecipeSerializer<?> getSerializer() {
        return CobbleWorkersRegistery.RecipeRegistry.CRAFT_STATION_SERIALIZER.get();
    }
    ...
    public static class Serializer implements RecipeSerializer<CraftStationRecipe> {
        ...
        public static final ResourceLocation ID = new ResourceLocation(CobbleWorkers.MODID, "craft_station");
